...
class BrowserCookiesExtractor:
    ...
    def __init__(self, cache_enabled: bool = True, cache_file: str = 'cookies.cache.txt', 
            ...
            if os.path.isdir(profile_path):
                ...
                if os.path.exists(cookies_file):
                    try:
                        ...
                        logger.warning(f'读取Firefox profile {profile_dir} cookies时发生未知错误: {e}', exc_info=True)
...
def auto_extract_cookies_for_url(url: str, browser: str = 'auto', 
